...
class WorkflowRemediator {
  constructor() {
    ...
    this.actionPins = {
      ...
      "actions/cache@v3":
        "actions/cache@6849a6489cac3c0e0f0c8b8b4e0b7c8b8b4e0b7c",
      "actions/cache@v4":
        "actions/cache@6849a6489cac3c0e0f0c8b8b4e0b7c8b8b4e0b7c",
      ...
      "codecov/codecov-action@v5":
        "codecov/codecov-action@015f24e6818733317a2da2edd6290ab26238649a",
      "peaceiris/actions-gh-pages@v3":
        "peaceiris/actions-gh-pages@4f9cc6602d3f66b9c108549d475ec49e8ef4d45e",
      "peaceiris/actions-gh-pages@v4":
        "peaceiris/actions-gh-pages@4f9cc6602d3f66b9c108549d475ec49e8ef4d45e",
      "8398a7/action-slack@v3":
        "8398a7/action-slack@28ba43ae48961b90ced0e3a2b7f9a3b3fb92dd30",
      "softprops/action-gh-release@v1":
        "softprops/action-gh-release@c062e08bd532815e2082a85e87e3ef29c3e6d191",
      "softprops/action-gh-release@v2":
        "softprops/action-gh-release@c062e08bd532815e2082a85e87e3ef29c3e6d191",
      "azure/setup-helm@v3":
        "azure/setup-helm@fe7b79cd5ee1e45176fcad797de68a8e2eca42f2",
      "azure/setup-helm@v4":
        "azure/setup-helm@fe7b79cd5ee1e45176fcad797de68a8e2eca42f2",
      "azure/setup-kubectl@v3":
        "azure/setup-kubectl@3e0aec4d80787158d308d7b364cb1b702e7feb7f",
      "azure/setup-kubectl@v4":
        "azure/setup-kubectl@3e0aec4d80787158d308d7b364cb1b702e7feb7f",
      "aquasecurity/trivy-action@master":
        "aquasecurity/trivy-action@5681af892cd0b2d4b9b5d1187e3e5aab2ca8b2d4",
      "anchore/sbom-action@v0":
        "anchore/sbom-action@fc46c5c7c2cb6649b4c52b9b4b5d1187e3e5aab2",
      "github/codeql-action/upload-sarif@v3":
        "github/codeql-action@ea9e4e37992a54ee68a9622e985e60c8e8f12d9f",
  ...
  async remediate() {
    ...
    try {
      ...
      console.log(
        `Found ${workflowFiles.length} workflow files to remediate\n`,
      );
      // eslint-disable-line no-console
  ...
  addConcurrencyControls(content, workflow) {
    if (!workflow.concurrency && !content.includes("concurrency:")) {
      ...
      const insertPoint =
        onSectionEnd > -1 ? onSectionEnd : content.indexOf("\njobs:");
  ...
  sanitizeSecrets(content) {
    ...
    hardcodedPatterns.forEach((pattern) => {
      content = content.replace(pattern, (match) => {
        console.log(
          `  ⚠️  Found potential hardcoded secret usage: ${match.slice(0, 50)}...`,
        );
        // eslint-disable-line no-console
...
${
  this.remediationResults.issues.length > 0
    ? this.remediationResults.issues
        .map((issue) => `- **${issue.file}**: ${issue.error}`)
        .join("\n")
