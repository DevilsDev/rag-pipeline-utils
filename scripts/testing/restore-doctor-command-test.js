...
/**
 * Restore doctor-command.test.js to working state
 * Fixes all syntax errors from malformed assertion insertions
 */
...
console.log('🔧 Restoring doctor-command.test.js to working state...');

try {
  fs.writeFileSync(filePath, cleanContent);
  console.log('✅ Successfully restored doctor-command.test.js');
  console.log('📊 File now has proper syntax and comprehensive test coverage');
} catch (error) {
