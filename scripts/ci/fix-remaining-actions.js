...
const ADDITIONAL_ACTION_SHA_MAP = {
  "actions/github-script@v6":
    "actions/github-script@60a0d83039c74a4aee543508d2ffcb1c3799cdea", // v6.4.1
  "actions/github-script@v7":
    "actions/github-script@35b1cdd1b2c1fc704b1cd442536d6e4b28b2ba4e", // v7.0.1
  "8398a7/action-slack@v3":
    "8398a7/action-slack@28ba43ae48961b90ced0e7aac97fc847a4ab1666", // v3.16.2
};
      ...
      if (job.steps) {
        for (const [stepIndex, step] of job.steps.entries()) {
          if (step.uses) {
            ...
            if (shaVersion) {
              console.log(
                `    📌 Pinning ${step.uses} → ${shaVersion.split("@")[1].substring(0, 8)}...`,
              );
