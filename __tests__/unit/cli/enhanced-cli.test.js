...
describe("Enhanced CLI Features", () => {
  ...
  describe("streaming functionality", () => {
    it("should handle stream flag correctly", () => {
      ...
      const result = execSync('node cli.js run --stream --query "test"', {
        encoding: "utf8",
      });
  ...
  describe("observability flags", () => {
    it("should handle trace flag", () => {
      ...
      const result = execSync('node cli.js run --trace --query "test"', {
        encoding: "utf8",
      });
      const parsed = JSON.parse(result);
    ...
    it("should handle verbose flag", () => {
      ...
      const result = execSync('node cli.js run --verbose --query "test"', {
        encoding: "utf8",
      });
      const parsed = JSON.parse(result);
    ...
    it("should handle stats flag", () => {
      ...
      const result = execSync('node cli.js run --stats --query "test"', {
        encoding: "utf8",
      });
      const parsed = JSON.parse(result);
